...
/***/ function(module, exports, __webpack_require__) {
	...
	var scoreEvents = __webpack_require__(4);
	var fileUploadEvents = __webpack_require__(11);
	var authEvents = __webpack_require__(14);
	var stickyNoteEvents = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSearchScore = function onSearchScore(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.searchScore(data).done(ui.displayScore).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var searchScore = function searchScore(data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tunesArray = [app.tune1, app.tune2, app.tune3]; //placed into app.js file
	var numberOfScoreViews = 0;

	var displayScore = function displayScore(data) {
	  ...
	  var musicBoxTemplate = _.template("<svg id='score-display-<%= numberOfScoreViews %>'>I am an SVG</svg>");
	  var compiledMusicBoxTemplate = musicBoxTemplate({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onFileUpload = function onFileUpload(event) {
	  event.preventDefault();
	  var selectedFile = $('#file-input-upload').get(0).files[0];
	  var fileReader = new FileReader();

	  fileReader.readAsText(selectedFile);
	  fileReader.onload = function (event) {
	    var fileText = event.target.result;
	    api.fileUpload(fileText).done(ui.fileUploadSuccess).fail(ui.failure);
	  };
	};

	var onDeleteTune1 = function onDeleteTune1(event) {
	  event.preventDefault();
	  api.deleteTune1();
	};

	var onDeleteTune2 = function onDeleteTune2(event) {
	  event.preventDefault();
	  api.deleteTune2();
	};

	var onDeleteTune3 = function onDeleteTune3(event) {
	  event.preventDefault();
	  api.deleteTune3();
	};
	...
	module.exports = {
	  ...
	  onDeleteTune1: onDeleteTune1,
	  onDeleteTune2: onDeleteTune2,
	  onDeleteTune3: onDeleteTune3
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fileUpload = function fileUpload(fileText) {
	  parseFile(fileText);
	  tune_data.user_id = app.user.id;
	  // let data = tune_data
	  var data = { tune_data: tune_data };
	  console.log(data);
	  return $.ajax({
	    url: app.host + '/tunes',
	    method: 'POST',
	...
	var parseFile = function parseFile(score) {
	...
	var matchKeys = function matchKeys(element, index, array) {
	  if (element.startsWith('T')) {
	    tune_data.tuneTitleT = element.slice(2).trimLeft();
	  }
	  if (element.startsWith('C')) {
	    tune_data.composerC = element.slice(2).trimLeft();
	  }
	  if (element.startsWith('O')) {
	    tune_data.originO = element.slice(2).trimLeft();
	  }
	  if (element.startsWith('A')) {
	    tune_data.areaA = element.slice(2).trimLeft();
	  }
	  if (element.startsWith('M')) {
	    tune_data.meterM = element.slice(2).trimLeft();
	  }
	  if (element.startsWith('L')) {
	    tune_data.unitNoteLengthL = element.slice(2).trimLeft();
	  }
	  if (element.startsWith('Q')) {
	    tune_data.tempoQ = element.slice(2).trimLeft();
	  }
	  if (element.startsWith('P')) {
	    tune_data.partsP = element.slice(2).trimLeft();
	  }
	  if (element.startsWith('Z')) {
	    tune_data.transcriptionZ = element.slice(2).trimLeft();
	  }
	  if (element.startsWith('N')) {
	    tune_data.notesN = element.slice(2).trimLeft();
	  }
	  if (element.startsWith('G')) {
	    tune_data.groupG = element.slice(2).trimLeft();
	  }
	  if (element.startsWith('H')) {
	    tune_data.historyH = element.slice(2).trimLeft();
	  }
	  if (element.startsWith('K')) {
	    tune_data.keyK = element.slice(2).trimLeft();
	  }
	  if (element.startsWith('R')) {
	    tune_data.rhythmR = element.slice(2).trimLeft();
	  }
	};

	var deleteTune1 = function deleteTune1() {
	  return $.ajax({
	...
	var deleteTune2 = function deleteTune2() {
	  return $.ajax({
	...
	var deleteTune3 = function deleteTune3() {
	  return $.ajax({
	...
	module.exports = {
	  ...
	  deleteTune1: deleteTune1,
	  deleteTune2: deleteTune2,
	  deleteTune3: deleteTune3
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports) {
	...
	var fileUploadSuccess = function fileUploadSuccess(data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var loadRegisterForm = function loadRegisterForm(event) {
	  event.preventDefault();
	...
	var loadLoginForm = function loadLoginForm(event) {
	  event.preventDefault();
	...
	var onRegister = function onRegister(event) {
	  ...
	  api.register(data).done(ui.registerSuccess).fail(ui.failure);
	  loadLoginForm(event);
	};
	...
	var onLogin = function onLogin(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.login(data).done(ui.loginSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSubmitStickyNote1 = function onSubmitStickyNote1(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.submitStickyNote1(data).done(ui.submitStickyNoteSuccess).fail(ui.failure);
	};

	var onSubmitStickyNote2 = function onSubmitStickyNote2(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.submitStickyNote2(data).done(ui.submitStickyNoteSuccess).fail(ui.failure);
	};

	var onSubmitStickyNote3 = function onSubmitStickyNote3(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.submitStickyNote3(data).done(ui.submitStickyNoteSuccess).fail(ui.failure);
	};
	...
	module.exports = {
	  addHandlers: addHandlers,
	  onSubmitStickyNote1: onSubmitStickyNote1,
	  onSubmitStickyNote2: onSubmitStickyNote2,
	  onSubmitStickyNote3: onSubmitStickyNote3
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var submitStickyNote1 = function submitStickyNote1(tune_data) {
	  var data = tune_data;
	...
	var submitStickyNote2 = function submitStickyNote2(tune_data) {
	  var data = tune_data;
	...
	var submitStickyNote3 = function submitStickyNote3(tune_data) {
	  var data = tune_data;
	...
	module.exports = {
	  submitStickyNote1: submitStickyNote1,
	  submitStickyNote2: submitStickyNote2,
	  submitStickyNote3: submitStickyNote3
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var submitStickyNoteSuccess = function submitStickyNoteSuccess(data) {
	...
	module.exports = {
	  submitStickyNoteSuccess: submitStickyNoteSuccess,
	  failure: failure
	};
